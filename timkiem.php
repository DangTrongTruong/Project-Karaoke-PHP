...
<head>
    ...
    <title>KoKo | Tìm Kiếm - <?php if (isset($_GET['tukhoa'])) {echo $_GET['tukhoa'];} ?></title>
    ...
    <div class="container desktop margin_x">
            ...
            <div class="row category-desktop">
                    <?php if (isset($_GET['tukhoa'])) {
                        $tukhoa = $_GET['tukhoa']; koko_timkiem($tukhoa);
                    }else{
                        echo '<p style="text-align: center; padding: 20px">Nhập vào từ khóa cần tìm kiếm</p>';
                    } ?>    
                </div>
            </div>
</div>
