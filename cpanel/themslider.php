                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title tieudetudong">Thêm slider</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                         ...
                         if (isset($_GET['id'])) {
                            ...
                            slider_update_quantri($idslider);
                             ...
                             <div class="card-body themphongcss">
                                 ...
                                 <label for="">
                                     <span>link</span>
                                     <input type="text" name="link" id="" placeholder="Đường dẫn">
                                 </label>
                                 <label for="">
                                     <button type="submit" class="btn btn-info" name="btnThem">Thêm slider</button>
                                 </label>
                             </div>
                             </form>';
                         }
                        ?>
                        <?php if(isset($_POST['btnThem'])||isset($_POST['btnUpdate'])){
                            $tieude = $_POST['tieude'];
                            ...
                            if (isset($_POST['btnThem'])) {
                                slider_them_quantri($tieude, $tmp_name, $name, $mota,$link);
                            }
                            if (isset($_POST['btnUpdate'])) {
                                $id = $_GET['id'];
                                slider_update($tieude, $tmp_name, $name, $mota,$link,$id);
                            }
                        }
