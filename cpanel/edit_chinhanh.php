            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Danh sách hệ thống</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="form-group">
                                    <label for="">Tên chi nhánh muốn sửa</label>
                                    <input type="text" class="form-control" name="tenSP" id="name" aria-describedby="helpId" placeholder="<?php $tenchinhanh=$_GET['tenchinhanh']; echo $tenchinhanh;  ?>">
                                </div>
                        <div class="card-body">
                            <form action="" method="POST">
                                <div class="form-group">
                                    <label for="">Tên chi nhánh mới</label>
                                    <input type="text" class="form-control" name="tenchinhanhmoi" id="name" aria-describedby="helpId" placeholder="Tên chi nhanh moi">
                                </div>
                                <div style="display:flex; justify-content:center" class="forn-group">
                                        <button  type="submit" class="btn btn-primary" name="btnSua" value="">Sửa</button>
                                </div>
                            </form>
                            <?php
                            $idchinhanh=$_GET['idchinhanh'];
                            if(isset($_POST['btnSua'])){
                                    $tenchinhanhmoi=$_POST['tenchinhanhmoi'];
                                    suatenchinhanh($idchinhanh,$tenchinhanhmoi);
