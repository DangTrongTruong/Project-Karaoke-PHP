                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title update_title">Quản lý hệ thống</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->

                        <?php sua_list_hethong() ?>
                        <?php 
                            if (isset($_POST['btnUpdate'])) {
                                $images_logo = $_FILES['images_logo']['tmp_name'];
                                $images_logo_name = $_FILES['images_logo']['name'];
                                $hotline = $_POST['hotline'];
                                $email = $_POST['email'];
                                $facebook = $_POST['facebook'];
                                $diachi = $_POST['diachi'];
                                sua_hethong($images_logo,$images_logo_name,$hotline,$email,$facebook,$diachi);
                            }
                        ?>
