            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title doitieude">Ảnh chi tiết của từng phòng</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        <!-- <div class="card">
                            <div class="card-body">
                                <a href="" class="btn btn-info">Thêm ảnh sản phẩm</a>
                            </div>
                        </div> -->
                        <?php if (isset($_GET['idphong'])) {
                                $idphong = $_GET['idphong'];
                                check_iphong_anhchitiet($idphong);
                        }else{
                            echo '<div class="card">
                            <div class="card-body">
                                <table class="table">
                    ...
                    <?php
                        if (isset($_POST['btnThem_anh']) || isset($_POST['btnUpdate_anh'])) {
                            $anh1_name = $_FILES['upload1']['name'];
                            $anh1_tmp = $_FILES['upload1']['tmp_name'];
                            $anh2_name = $_FILES['upload2']['name'];
                            $anh2_tmp = $_FILES['upload2']['tmp_name'];
                            $anh3_name = $_FILES['upload3']['name'];
                            $anh3_tmp = $_FILES['upload3']['tmp_name'];
                            $anh4_name = $_FILES['upload4']['name'];
                            $anh4_tmp = $_FILES['upload4']['tmp_name'];
                            $idphong = $_GET['idphong'];
                            if (isset($_POST['btnThem_anh'])) {
                                them_anhchitiet_phong($anh1_name,$anh1_tmp,$anh2_name,$anh2_tmp,$anh3_name,$anh3_tmp,$anh4_name,$anh4_tmp,$idphong);
                            }
                            if (isset($_POST['btnUpdate_anh'])) {
                                update_anhchitiet_phong($anh1_name,$anh1_tmp,$anh2_name,$anh2_tmp,$anh3_name,$anh3_tmp,$anh4_name,$anh4_tmp,$idphong);
                            }
                        }

                        if (isset($_GET['idphongxoa'])) {
                            $idphongxoa = $_GET['idphongxoa'];
                            xoa_anhchitiet_phong($idphongxoa);
                        }
                        if (isset($_GET['idphongsua'])) {
                            $idphongsua = $_GET['idphongsua'];
                            xoa_anhchitiet_phong($idphongsua);
                        }
                    ?>
                    </div> <!-- container -->
