            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title update_title tieudetudong">Viết bài</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                        ...
                        <?php 
                            if (isset($_POST['btnDangbai']) || isset($_POST['btnSuabai'])) {
                                    $tenbaiviet = $_POST['tenbaiviet'];
                                    $tmp_name = $_FILES['upload']['tmp_name'];
                                    $name = $_FILES['upload']['name'];
                                    $noidung = $_POST['noidung'];
                                    $nguoiviet = $_SESSION['taikhoan'];
                                if (isset($_POST['btnDangbai'])) {
                                    dangbai($tenbaiviet, $tmp_name, $name, $noidung,$nguoiviet);
                                }
                                if (isset($_POST['btnSuabai'])) {
                                    $idbaiviet_update = $_GET['idbaiviet_update'];
                                    updatebaiviet($idbaiviet_update,$tenbaiviet, $tmp_name, $name, $noidung);
                                }
                            }
                        ?>
