                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        if ($result->num_rows>0) {
                         echo '<div class="card">
                         <div class="card-body">
                         <h3>Tạo mới chi nhánh</h3>
                             <form action="" method="POST">
                                
                                 <input style="border: 1px solid var(--green); background:none;" class="btn btn-info" type="text" name="tenchinhanh" placeholder="Nhập tên chi nhánh tạo mới">
                                 <input class="btn btn-info" type="submit" name="taomoi" value="Tạo mới chi nhánh">

                             </form>';
                             
                             if(isset($_POST['taomoi'])){
                                     $tenchinhanh=$_POST['tenchinhanh'];
                                     themchinhanh($tenchinhanh);
                             }
                     ...
                     <div class="card">
                         <div class="card-body">
                             <table class="table">
                                 ...
                                 <tbody>';
                                      quanlychinhanh();
                                      if (isset($_GET['idchinhanh'])) {
                                        xoachitietanh_(); xoaformdatphong(); xoachinhanh();
                                    } 
                                echo '</tbody>
                             </table>
                         </div>
