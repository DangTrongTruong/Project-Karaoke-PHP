                        ...
                        <div class="card-body">
                            <form action="">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tenSP" id="name" aria-describedby="helpId" placeholder="Tên sản phẩm">
                                </div>
                                <div class="form-group">
                                    <label for="">Tên chi nhánh</label>
                                    <select class="form-control" name="iddm" id="">
                                        <option>---Tên chi nhánh---</option>
                                        <option value="">Chi nhánh hà nội</option>
                                        <option value="">Chi nhánh hải phòng</option>

                                    </select>
                                </div>
                                <div style="display:flex; justify-content:center" class="forn-group">
                                        <button  type="submit" class="btn btn-primary" name="btnThem" value="btnThem">Thêm loại phòng</button>
                                </div>
                            </form>
                        </div>
                    </div>
