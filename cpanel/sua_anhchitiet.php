...
<?php ob_start(); ?>
    <head>
        ...
        <style>
            #select_suatrangthai,#soluongnguoi__,#tenphong__,#ngay,#gio{
                padding: 10px;
                border-radius: .5rem;
                cursor: pointer;
                outline: none;
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Sửa ảnh chi tiết</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        if(isset($_POST['btnUpdate'])){
                            $trangthaidatphong = $_POST['select_tranthai'];
                            $ngaydatphong__ = $_POST['ngay_datphong'];
                            $giodatphong__ = $_POST['gio_datphong'];
                            $soluongnguoi__ = $_POST['soluongnguoi__'];
                            $idphong__ = $_POST['tenphong'];
                            update_suatrangthai($trangthaidatphong,$idform,$ngaydatphong__,$giodatphong__,$soluongnguoi__,$idphong__);
